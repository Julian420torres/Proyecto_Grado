        ...
        <div class="card-body">
            <table id="datatablesSimple" class="table table-striped fs-6">
                ...
                <tbody>
                            ...
                            <div class="d-flex justify-content-around">
                                <div>
                                    ...
                                    <ul class="dropdown-menu text-bg-light" style="font-size: small;">
                                        <li>
                                            <a class="dropdown-item" href="#" data-bs-toggle="modal" data-bs-target="#verModal-{{ $menu->id }}">Ver</a>
                                        </li>
                                        <li>
                                            <a class="dropdown-item" href="{{ route('menus.edit', $menu->id) }}">Editar</a>
                                        </li>
                                    </ul>
                                </div>
                                <div>
                                ...
                                <div>
                                <form action="{{ route('menus.destroy', $menu->id) }}" method="post" onsubmit="return confirm('¿Seguro que deseas eliminar este menú?');">
                                        @csrf
                                        @method('DELETE')
                                        <button title="Eliminar" class="btn btn-datatable btn-icon btn-transparent-dark" type="submit">
                    ...
                    <!-- Modal -->
<div class="modal fade" id="verModal-{{$menu->id}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <img src="{{ asset('storage/'.$menu->imagen) }}" 
                    ...
                    <div class="col-12">
                        <p><span class="fw-bolder">Precio: </span>${{ number_format($menu->precio, 2) }}</p>
                    </div>
                </div>
            </div>
